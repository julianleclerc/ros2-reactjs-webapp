#include "new_action_1742821187005/temoto_action.hpp"

class NewAction_1742821187005 : public TemotoAction
{
public:
...
}; // NewAction_1742821187005 class

// REQUIRED, do not remove
boost::shared_ptr<ActionBase> factory()
{
    return boost::shared_ptr<NewAction_1742821187005>(new NewAction_1742821187005());
}

// REQUIRED, do not remove
BOOST_DLL_ALIAS(factory, NewAction_1742821187005)