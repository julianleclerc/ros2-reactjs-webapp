#include "new_action_1742969413796/temoto_action.hpp"

class NewAction_1742969413796 : public TemotoAction
{
public:
...
}; // NewAction_1742969413796 class

// REQUIRED, do not remove
boost::shared_ptr<ActionBase> factory()
{
    return boost::shared_ptr<NewAction_1742969413796>(new NewAction_1742969413796());
}

// REQUIRED, do not remove
BOOST_DLL_ALIAS(factory, NewAction_1742969413796)