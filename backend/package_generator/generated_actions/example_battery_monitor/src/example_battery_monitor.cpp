#include "example_battery_monitor/temoto_action.hpp"

class ExampleBatteryMonitor : public TemotoAction
{
public:
...
}; // ExampleBatteryMonitor class

// REQUIRED, do not remove
boost::shared_ptr<ActionBase> factory()
{
    return boost::shared_ptr<ExampleBatteryMonitor>(new ExampleBatteryMonitor());
}

// REQUIRED, do not remove
BOOST_DLL_ALIAS(factory, ExampleBatteryMonitor)